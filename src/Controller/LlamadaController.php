...
class LlamadaController extends Controller
{
	...
	public function nuevo(Request $request, $codigoLlamada = null)
	{
		...
		return $this->render('App:Llamada:crear.html.twig',
			array(
	...
	public function lista(Request $request)
	{
		...
		return $this->render('App:Llamada:listar.html.twig', array(
			'llamadas' => $arLlamadas,
	...
	public function listaUsuario(Request $request)
	{
		...
		return $this->render('App:Llamada:listarUsuario.html.twig', [
			'llamadas' => $arLlamada,
	...
	public function listaReporte(Request $request)
	{
		...
		return $this->render('App:Llamada:listarGeneral.html.twig', [
			'llamadas' => $arLlamadas,
			//'user' => $user,
			'formFiltro' => $formFiltro->createView()
		]);
